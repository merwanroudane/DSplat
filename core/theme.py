...
def register_plotly_template() -> None:
    """A warm, light Plotly template used by every figure in the app."""
    if "ds_academy" in pio.templates:
        return
    ...
    pio.templates["ds_academy"] = template
    pio.templates.default = "plotly_white+ds_academy"
